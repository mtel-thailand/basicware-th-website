...
/** Placeholder — full AI Talent Education content lands in a later task. */
export const aiTalentEducation: ServiceContent = {
  slug: "ai-talent-education",

  meta: {
    title: "AI Talent Education",
    description: "Content for this page is coming soon.",
  },

  hero: {
    eyebrow: "Services",
    title: { pre: "AI Talent ", accent: "Education", post: "" },
    lede: "Content for this page is coming soon. Check back soon for the full AI Talent Education service page.",
  },
