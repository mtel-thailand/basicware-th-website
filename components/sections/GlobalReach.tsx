...
const PINS = [
  { left: 22.3, top: 63.2, spriteLeft: "-428.96%", spriteTop: "-66.28%" },
  { left: 20.1, top: 42.1, spriteLeft: "-420.44%", spriteTop: "-196.8%" },
  { left: 44.7, top: 20.4, spriteLeft: "-167.42%", spriteTop: "-196.8%" },
  { left: 74.6, top: 16.5, spriteLeft: "-36.66%", spriteTop: "-196.87%" },
  { left: 24.6, top: 46.1, spriteLeft: "-298.64%", spriteTop: "-196.8%" },
  { left: 32.4, top: 49.0, spriteLeft: "-298.64%", spriteTop: "-66.28%" },
  { left: 31.3, top: 79.3, spriteLeft: "-167.42%", spriteTop: "-66.28%" },
  { left: 41.8, top: 31.5, spriteLeft: "-36.65%", spriteTop: "-66.28%" },
];
